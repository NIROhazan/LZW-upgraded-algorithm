	...
	public class UpgradedLZWCompression {
	    ...
	    /** Maximum dictionary size to limit memory usage - default value 4096 . */
	    private static int maxDictionarySize =4096;
	
	    /** Initial dictionary size - default value 256*/
	    private static  int initialDictionarySize = 256;
	    
	
	    /** Minimum compression ratio before resetting the dictionary */
	    // Data Compression Ratio - measurement of the relative reduction in size of data representation produced by a data compression algorithm (wikipedia)
	    private static double minCompressionRatio = 0.75;
	    ...
	    /**
	     * Compresses a byte array using the LZW algorithm with dynamic dictionary management.
	     *
